    ...
    <nav class="booking-nav fixed top-0 inset-x-0 z-50">
        <div class="booking-nav-inner">
            <a href="{{ url('/') }}" class="booking-nav-logo flex items-center" aria-label="bookdei home">
                <img src="{{ asset('images/logo.png') }}" alt="bookdei" class="w-auto object-contain drop-shadow-sm transition-transform duration-300 hover:scale-105" style="height: 48px; margin-left: -10px;">
            </a>
