<x-admin-layout pageTitle="Promotions" pageSubtitle="Manage discount codes and special deals">
                    ...
                    @forelse($promotions as $promo)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-3 px-5 text-right flex justify-end gap-2">
                                <a href="{{ route('admin.promotions.edit', $promo) }}" class="text-brand-primary hover:text-brand-primary-dark p-2">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('admin.promotions.destroy', $promo) }}" method="POST" class="inline-block" onsubmit="return confirm('Delete this promotion?');">
                                    @csrf
                                    @method('DELETE')
