<x-admin-layout pageTitle="New Promotion" pageSubtitle="Create a discount code or special offer">

    <div class="max-w-3xl">
        <form action="{{ route('admin.promotions.store') }}" method="POST" enctype="multipart/form-data" class="card card-body space-y-6">
            @csrf
