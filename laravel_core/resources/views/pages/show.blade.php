...
<head>
    ...
    <title>{{ $title ?? 'Page' }} - GHURI OTA</title>
    <!-- Favicon -->
    ...
    <style>
        .booking-nav {
            background-color: #006ce4 !important; /* Ensure nav is solid blue since it's not over an image */
        }
    </style>
</head>
<body class="font-sans antialiased bg-gray-50 text-dark selection:bg-[#d00e15] selection:text-white flex flex-col min-h-screen">
                    ...
                    @auth
                        ...
                        @if ($isInternalUser)
                            ...
                            <form method="POST" action="{{ route('logout') }}" class="inline">
                                @csrf
                                <button type="submit" class="booking-nav-auth-button border-none bg-transparent">Logout</button>
                            </form>
                        @else
                            <div x-data="{ open:false }" class="relative inline-block">
                                <button @click="open = !open" type="button" class="booking-nav-account" aria-label="Open account menu">
                                    ...
                                    <svg class="w-4 h-4 transition text-white ml-2" :class="{ 'rotate-180': open }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div
                                    ...
                                    x-transition
                                    style="display:none;"
                                    class="absolute right-0 mt-2 w-64 bg-white border border-gray-100 rounded-xl shadow-xl overflow-hidden text-left"
                                >
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
                ...
                <div class="prose prose-lg prose-blue max-w-none text-gray-600">
                    ...
                    <p class="mb-4">At GHURI, we are committed to ensuring your travel experience is smooth, reliable, and perfectly tailored to your needs. This page will soon feature detailed insights and helpful resources.</p>
    ...
    <!-- Footer -->
    <footer class="bg-[#0B1120] text-gray-300 py-16 border-t border-gray-800 font-sans mt-auto" style="background-color: #0B1120;">
